...
const AccountRegisteredSuccessfull = () => {
  ...
  return (
    <View style={[styles.accountRegisteredSuccessfull, styles.card4Layout]}>
      ...
      <View style={styles.accountRegisteredSuccessfullChild} />
      ...
      <View style={[styles.card4, styles.card4Position]}>
        ...
        <Text style={[styles.welcomeOnboard, styles.text16Typo]}>
          Welcome onboard!
        </Text>
        <Pressable
