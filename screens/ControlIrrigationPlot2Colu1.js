  ...
  return (
    <View style={styles.controlIrrigationPlot2Colu}>
      ...
      <View style={[styles.controlNavBarParent, styles.sliderlabelPosition]}>
        ...
        />
        <View
          style={[styles.hackTheBrainOnboard11Parent, styles.textfieldLayout]}
        >
          <Pressable
      ...
      <View style={styles.controlIrrigationPlot2ColuChild} />
      ...
      <View style={styles.controlIrrigationPlot2ColuItem} />
      ...
      <View style={styles.textfield1}>
        <View style={styles.input1}>
          ...
          <View style={[styles.input2, styles.input2SpaceBlock]}>
            ...
            <Text style={[styles.label1, styles.textTypo]}>13 Litres</Text>
            <Image
              style={styles.adornEndContainer}
              contentFit="cover"
      ...
      <View style={styles.slider}>
        <View style={styles.slider1}>
          ...
          <View style={[styles.marks, styles.marksFlexBox]}>
            <View style={[styles.slidermark, styles.recLayout1]}>
      ...
      <View style={styles.slider2}>
        <View style={[styles.sliderrail1, styles.rec11Bg]} />
        <View style={[styles.slidertrack1, styles.rec11Bg]} />
        <View style={[styles.marks, styles.marksFlexBox]}>
          <View style={[styles.slidermark, styles.recLayout1]}>
            <View style={[styles.rec11, styles.rec11Bg]} />
      ...
      <View style={[styles.select, styles.selectLayout]}>
        <View style={styles.input3}>
          <View style={[styles.container, styles.activeFlexBox]}>
            ...
            <Text style={[styles.placeholder, styles.labelFlexBox]}>
              Placeholder
            </Text>
          ...
          <View style={styles.labelContainer}>
            <Text style={[styles.label2, styles.labelTypo]}>Column</Text>
          </View>
        </View>
        <View style={[styles.formhelpertext, styles.formhelpertextSpaceBlock]}>
      ...
      <View style={[styles.select1, styles.selectLayout]}>
        <View style={styles.input1}>
          <Text style={[styles.label3, styles.textTypo]}>Column</Text>
      ...
      <View style={[styles.switch1, styles.switchPosition]}>
        <View style={[styles.slide, styles.slidePosition]}>
          <View style={[styles.slide3, styles.rec11Bg]} />
        </View>
        <View style={[styles.knob, styles.knobPosition]}>
          <Image
            style={styles.knobIcon}
      ...
      <View style={[styles.switch2, styles.switchPosition]}>
        <View style={[styles.slide, styles.slidePosition]}>
          <View style={[styles.slide5, styles.slideLayout]} />
        </View>
        <View style={[styles.knob, styles.knobPosition]}>
          <Image
            style={styles.knobIcon}
