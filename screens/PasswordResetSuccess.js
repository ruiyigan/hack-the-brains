...
const PasswordResetSuccess = () => {
  ...
  return (
    <View style={[styles.passwordResetSuccess, styles.card4Layout]}>
      ...
      <View style={styles.passwordResetSuccessChild} />
      ...
      <View style={[styles.card4, styles.card4Position]}>
        ...
        <Text
          style={[styles.pleaseDoNot, styles.text16Typo]}
        >{`Please do not forget your password
and keep them safely!`}</Text>
        <Pressable
