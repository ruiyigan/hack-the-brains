    ...
    <View style={styles.forgotPasswordConcealed}>
      ...
      <View style={[styles.barStatus, styles.barStatusLayout]}>
        ...
        <View style={[styles.timeStyle, styles.timeLayout]}>
          <Text style={[styles.time, styles.newTypo]}>9:41</Text>
        </View>
      </View>
      ...
      <View style={[styles.forgotPasswordConcealedChild, styles.iconLayout1]} />
      <View style={[styles.barTab2Project, styles.barLayout]}>
        <View style={[styles.tabBar, styles.text2FlexBox]}>
          ...
          <View style={[styles.inactive, styles.activeSpaceBlock]}>
            <Text style={[styles.inactive1, styles.newTypo]}>Completed</Text>
          </View>
          <View style={[styles.inactive, styles.activeSpaceBlock]}>
            <Text style={[styles.inactive1, styles.newTypo]}>Flag</Text>
          </View>
        </View>
      </View>
      ...
      <View style={[styles.card4, styles.card4Position]}>
        ...
        <View style={[styles.navigation, styles.card4Position]}>
          <Text style={[styles.search, styles.searchTypo]}>Reset Password</Text>
          <Image
        ...
        <View style={[styles.textFieldPrimaryText2, styles.textShadowBox]}>
          <Text style={[styles.text17, styles.newTypo]}>*****************</Text>
          <Image
...
export default ForgotPasswordConcealed;
