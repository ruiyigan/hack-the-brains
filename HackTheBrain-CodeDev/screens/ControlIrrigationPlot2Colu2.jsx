  ...
  return (
    <View style={styles.controlIrrigationPlot2Colu}>
      ...
      <View style={[styles.active, styles.activeFlexBox]}>
        <Text style={styles.irrigation}>Sunlight</Text>
      </View>
      ...
      <Pressable style={styles.hackTheBrainOnboard11Parent} onPress={() => navigation.navigate("ControlIrrigationPlot2Colu")}> 
        <Image
